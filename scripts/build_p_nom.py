...
def build_p_nom():
    ...
    offwind_capacity.to_hdf(
        snakemake.output.offwind_capacity, key=offwind_capacity.name
    )
    ...
    nuclear_capacity.to_hdf(
        snakemake.output.nuclear_capacity, key=nuclear_capacity.name
    )
